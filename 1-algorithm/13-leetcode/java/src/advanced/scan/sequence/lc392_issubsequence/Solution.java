package advanced.scan.sequence.lc392_issubsequence;
 ...
 * and s is a short string (<=100). A subsequence of a string is a new string which is formed from the original string
...
public class Solution {
    ...
    // My 2AC: O(M+N)
    public boolean isSubsequence_once(String s, String t) {
        int i = 0;
